...
// Leaderboard data - we'll use static data for now since scraping is complex
const LEADERBOARD_DATA = {
  "game_uri": "baird-pwm-intern-stock-market-competition",
  "competitors": [
    { "public_id": "-Ct8JFv9TYip", "name": "cj deslongchamps", "rank": 1 },
    { "public_id": "_8Wq2c1c3_KU", "name": "Sam Klein", "rank": 2 },
    { "public_id": "PC71jGgKlLH-", "name": "Will Hemauer", "rank": 3 },
    { "public_id": "DZIwD2ECcFRC", "name": "Sebastian Babu", "rank": 4 },
    { "public_id": "HRBmKqN6Syly", "name": "Ryan Carew", "rank": 5 },
    { "public_id": "BB-z-hSCXbOT", "name": "Ethan Houseworth", "rank": 6 },
    { "public_id": "4uvjV2dXQ4SZ", "name": "Jack DePrey", "rank": 7 },
    { "public_id": "WArCf7i9ryyb", "name": "Luke Sagone", "rank": 8 },
    { "public_id": "eHQgXe9W7f8M", "name": "Steve Perkins", "rank": 9 },
    { "public_id": "iIDZxw5xNBMY", "name": "Lily Valimont", "rank": 10 },
    { "public_id": "XArvdHeUXb1q", "name": "Griffin Fanger", "rank": 11 },
    { "public_id": "9BaDE7wJmTD2", "name": "Milla MacLeod", "rank": 12 },
    { "public_id": "zvZv24UsJIFb", "name": "Eileen Carey", "rank": 13 },
    { "public_id": "LXCJkeLdPbuA", "name": "Caroline Gundersen", "rank": 14 },
    { "public_id": "lzmy429KW9qb", "name": "Jack Pinsky", "rank": 15 },
    { "public_id": "HmJ0d8Dzu6nT", "name": "Leah Wong", "rank": 16 },
    { "public_id": "eDoajzvdSnYh", "name": "Katie Perritt", "rank": 17 },
    { "public_id": "lSznByCwYnaw", "name": "Sam LoCoco", "rank": 18 },
    { "public_id": "3zPM3BlrtN6C", "name": "Shega Case", "rank": 19 }
  ]
};
...
async function scrapeCompetitionData() {
  ...
  // Create name mapping
  LEADERBOARD_DATA.competitors.forEach(comp => {
    nameMap[comp.public_id] = comp.name;
  });

  // Scrape each competitor
  for (let i = 0; i < LEADERBOARD_DATA.competitors.length; i++) {
    const comp = LEADERBOARD_DATA.competitors[i];
    console.log(`Scraping competitor ${i + 1}/${LEADERBOARD_DATA.competitors.length}: ${comp.public_id}`);
    ...
    try {
      ...
      if (portfolioData && portfolioData.data && portfolioData.data.values) {
        ...
        console.log(`  ✓ ${competitor.name} - Rank #${competitor.rank} - $${competitor.portfolio_value.toLocaleString()}`);
      } else {
